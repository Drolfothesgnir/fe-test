...
import getProducts, { getBrands, getColors, getPriceRange } from './utils/getProducts';
  ...
  return (
    <Stack sx={{ minHeight: '100vh' }}>
      ...
      <Container component='main' maxWidth='xl' sx={{ flexGrow: 1, pb: 3 }}>
        <Box>
          <FilterRemovers filterApi={filterApi} exclude={{ sort: { rating: true, price: true } }} />
        </Box>
...
function colorFilterLabel(name: string) {
  ...
  return (
    ...
    >
      <Typography component='span' sx={{ textTransform: 'capitalize', fontSize: '14px' }}>
        {name}
      </Typography>
      <Box
        component='span'
